// Final test: verify the new growRegions implementation achieves 50%+ solvability
// Mirrors the exact logic from client/src/lib/levelGen.ts
...
function growRegions(N, seeds, rng) {
  const N_SINGLETON = Math.floor(N * 0.6)   // 6
  const N_SMALL     = Math.floor(N * 0.3)   // 3
...
console.log(totalSolvable/totalAttempts >= 0.5 ? '\n✓ PASS: 50%+ solvable' : '\n✗ FAIL: below 50%')
