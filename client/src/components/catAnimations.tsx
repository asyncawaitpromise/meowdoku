...
export function CatPopReveal({ timing, duration }: { timing: string; duration: number }) {
  return (
...
export function CatDrawReveal({ timing, duration }: { timing: string; duration: number }) {
...
export function CatShatterReveal({ timing, duration, tileColor }: { timing: string; duration: number; tileColor: string }) {
