// Explore more configurations around the sweet spot
...
// Finer grid of configurations
const configs = [
  { nS: 6, nSm: 2, nL: 2, st: 2, label: '6sing+2small(2)+2large' },
  { nS: 6, nSm: 2, nL: 2, st: 3, label: '6sing+2small(3)+2large' },
  { nS: 6, nSm: 3, nL: 1, st: 2, label: '6sing+3small(2)+1large' },
  { nS: 6, nSm: 3, nL: 1, st: 3, label: '6sing+3small(3)+1large' },
  { nS: 6, nSm: 4, nL: 0, st: 2, label: '6sing+4small(2)+0large' },
  { nS: 7, nSm: 1, nL: 2, st: 2, label: '7sing+1small(2)+2large' },
  { nS: 7, nSm: 1, nL: 2, st: 3, label: '7sing+1small(3)+2large' },
  { nS: 7, nSm: 2, nL: 1, st: 2, label: '7sing+2small(2)+1large' },
  { nS: 7, nSm: 2, nL: 1, st: 3, label: '7sing+2small(3)+1large' },
  { nS: 7, nSm: 3, nL: 0, st: 2, label: '7sing+3small(2)+0large' },
  { nS: 7, nSm: 3, nL: 0, st: 3, label: '7sing+3small(3)+0large' },
  { nS: 8, nSm: 1, nL: 1, st: 2, label: '8sing+1small(2)+1large' },
  { nS: 8, nSm: 1, nL: 1, st: 3, label: '8sing+1small(3)+1large' },
  { nS: 8, nSm: 2, nL: 0, st: 2, label: '8sing+2small(2)+0large' },
]
...
for (const { nS, nSm, nL, st, label } of configs) {
  ...
  console.log(`${label}: ${total}/1000 (${(total/10).toFixed(1)}%) ${total >= 500 ? '✓ PASS' : ''}`)
}
